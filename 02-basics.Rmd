...
```{r data35c, echo=T,   eval=F ,message=FALSE,    collapse = T,   fig.width=5.5, warning=F,  fig.height=2.5}
require( mosaic )
require(pillar)
```
...
```{r gr4, echo=T,   eval=T ,message=FALSE,    collapse = T,   fig.width=5.5, warning=F,  fig.height=3.5}
...
```{r gr4a, echo=T,   eval=T ,message=FALSE,    collapse = T,   fig.width=5.5, warning=F,  fig.height=3.5}
glimpse( trees )
```	

To extract the variable `Volume`, do the following:
```{r gr4cb, echo=T,   eval=T ,message=FALSE,    collapse = T,   fig.width=5.5, warning=F,  fig.height=3.5}
trees$Volume 
...
Example:
```{r gr5, echo=T,   eval=F ,message=FALSE,    collapse = T,   fig.width=5.5, warning=F,  fig.height=2.5}
...
```{r gr5a, echo=T,   eval=T ,message=FALSE,    collapse = T,   fig.width=5.5, warning=F,  fig.height=2.5}
mean( ~ salary  , data=  mlbDataImport )
```	

```{r gr6, echo=T,   eval=F ,message=FALSE,    collapse = T,   fig.width=5.5, warning=F,  fig.height=2.5}
> Mean( ~ salary  , data=  mlbDataImport )
...
Example: 
```{r gr7, echo=T,   eval=F ,message=FALSE,    collapse = T,   fig.width=5.5, warning=F,  fig.height=2.5}
> MlbDataImport
...
```{r gr8, echo=T,   eval=F ,message=FALSE,    collapse = T,   fig.width=5.5, warning=F,  fig.height=2.5}
> histogram( ~ salary  , data=  mlbDataImport ) ) ) 
...
```{r gr9, echo=T,   eval=F ,message=FALSE,    collapse = T,   fig.width=5.5, warning=F,  fig.height=2.5}
> histogram( ~ salary  , data=  mlbDataImport 
+ 
+ 
+ 
